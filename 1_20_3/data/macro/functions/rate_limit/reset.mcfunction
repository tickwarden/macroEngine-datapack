...
tellraw @s {"text":"","extra":[{"text":"[Rate Limit] ","color":"yellow"},{"text":"Your rate limit state has been reset.","color":"green"}]}

# Log to admins
execute as @a[tag=macro.admin] run tellraw @s {"text":"","extra":[{"text":"[Rate Limit] ","color":"yellow"},{"selector":"@s","color":"white"},{"text":"'s rate limit state was reset.","color":"gray"}]}
