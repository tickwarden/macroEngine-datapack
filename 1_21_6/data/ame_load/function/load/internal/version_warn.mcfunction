setblock -30000000 0 1600 minecraft:test_block[mode=log]{mode:"log",message:"❌ [AME] Version conflict detected. Expected v2.1.0-pre1. Run /reload in-game for details."}

tellraw @a ["",{"text":"❌ ","color":"red"},{"text":"[AME] ","color":"aqua","bold":true},{"text":"Version conflict! ","color":"red","bold":true},{"text":"Expected ","color":"gray"},{"text":"v2.1.0-pre3","color":"yellow","bold":true},{"text":" — stored scores do not match.","color":"gray"}]
