execute unless data storage macro:engine global run data modify storage macro:engine global set value {version:"v4.0.1"}
data modify storage macro:engine global.version set value "v4.0.1"
