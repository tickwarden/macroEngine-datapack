execute unless data storage macro:engine global run data modify storage macro:engine global set value {version:"v2.2.1"}
data modify storage macro:engine global.version set value "v2.2.1"
...
execute if score #ame.ver_set ame.pre_version matches 1 run execute unless score #ame.minor ame.pre_version matches 2 run scoreboard players set #ame.mismatch ame.pre_version 1
