...
execute if score #ame.ver_set ame.pre_version matches 1 run execute unless score #ame.pre ame.pre_version matches 4 run scoreboard players set #ame.mismatch ame.pre_version 1
