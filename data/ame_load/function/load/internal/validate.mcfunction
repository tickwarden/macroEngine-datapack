execute unless data storage macro:engine global run data modify storage macro:engine global set value {version:"v3.0.2"}
data modify storage macro:engine global.version set value "v3.0.2"
