execute unless data storage macro:engine global run data modify storage macro:engine global set value {version:"v2.1.0-pre3"}
data modify storage macro:engine global.version set value "v2.1.0-pre3"
