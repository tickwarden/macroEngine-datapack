execute unless data storage macro:engine _mcmd_list[0] run execute as @a[tag=macro.debug] run tellraw @s ["",{"text":"[AME] ","color":"#00AAAA","bold":true},{"text":"cmd/multi_cmd ","color":"aqua"},{"text":"DONE ","color":"green"},{"text":"command list exhausted","color":"#555555"}]
